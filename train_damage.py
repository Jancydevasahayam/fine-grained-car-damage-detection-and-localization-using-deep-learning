"""Train damage classifier (damaged / undamaged) using transfer learning.
...
EPOCHS_HEAD = 16
EPOCHS_FINE_TUNE = 8
CLASS_ORDER = ["undamaged", "damaged"]
SEED = 42

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "datasets" / "damage"
MODEL_OUT = BASE_DIR / "models" / "damage_model.keras"
...
def train_model(
    ...
    print("Damage dataset distribution:")
    ...
    print(f"Damage model saved to: {model_out}")
