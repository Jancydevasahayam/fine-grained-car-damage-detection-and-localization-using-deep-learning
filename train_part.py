"""Train MobileNetV2 model for car part classification.
...
EPOCHS_HEAD = 24
EPOCHS_FINE_TUNE = 10
CLASS_ORDER = ["trunk","tire","tail_light","side_mirror","rear_window","rear_door","rear_bumper","hood","headlamp","grille","front_door","front_bumper","fender","exhaust_pipe","door_handle"]
NUM_CLASSES = len(CLASS_ORDER)
SEED = 42

BASE_DIR = Path(__file__).resolve().parent
DATA_DIR = BASE_DIR / "datasets" / "parts"
MODEL_OUT = BASE_DIR / "models" / "part_classifier_mobilenetv2.keras"
...
def train_model(
    ...
    print("Part dataset distribution:")
    ...
    print(f"Part classifier model saved to: {model_out}")
    print("Class indices:", train_gen.class_indices)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train part classifier.")
